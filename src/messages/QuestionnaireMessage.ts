...
export class QuestionnaireMessage extends AgentMessage {
  /**
  ...
  @IsValidMessageType(QuestionnaireMessage.type)
  public readonly type = QuestionnaireMessage.type.messageTypeUri
