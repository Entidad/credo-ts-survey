...
exports.FooBarRecord = void 0;
const core_1 = require("@aries-framework/core");
class FooBarRecord extends core_1.BaseRecord {
    constructor(props) {
        var _a, _b, _c;
        super();
        this.type = FooBarRecord.type;
        if (props) {
    ...
    assertState(expectedStates) {
        ...
        if (!expectedStates.includes(this.state)) {
            throw new core_1.AriesFrameworkError(`Foo answer record is in invalid state ${this.state}. Valid states are: ${expectedStates.join(', ')}.`);
        }
    }
}
exports.FooBarRecord = FooBarRecord;
FooBarRecord.type = 'FooBarRecord';
//# sourceMappingURL=FooBarRecord.js.map