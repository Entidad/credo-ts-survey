...
const QuestionnaireRecord_1 = require("./QuestionnaireRecord");
let QuestionnaireRepository = class QuestionnaireRepository extends core_1.Repository {
    constructor(storageService, eventEmitter) {
        super(QuestionnaireRecord_1.QuestionnaireRecord, storageService, eventEmitter);
    }
};
QuestionnaireRepository = __decorate([
    (0, core_1.injectable)(),
